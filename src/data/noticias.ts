...
export const todasLasNoticias: Noticia[] = [
        {
                ...
                contenidoLargo: "Las finales disputadas el 31 de marzo, se definieron los últimos seis boletos para la Copa del Mundo 2026, República Democrática del Congo (CAF) — Venció 1-0 a Jamaica en la final intercontinental (primera vez en su historia moderna). Irak (AFC) — Derrotó 2-1 a Bolivia en la otra final intercontinental (regresa después de 40 años, desde México 1986). Bosnia y Herzegovina (UEFA) — Eliminó a Italia en penales (1-1, 4-1 en tiros desde el punto penal). Suecia (UEFA) — Venció 3-2 a Polonia (con gol agónico de Gyökeres). Turquía (UEFA) — Ganó 1-0 a Kosovo. República Checa (UEFA) — Superó a Dinamarca en penales (2-2, 3-1 en la tanda). Estas fueron las últimas seis en asegurar su boleto al torneo de 48 selecciones. Intercontinental (en México): Congo y Irak completaron los dos cupos restantes. UEFA: Bosnia, Suecia, Turquía y República Checa dejaron fuera a potencias como Italia, Polonia y Dinamarca. La selección argentina, campeona defensora y número 1 del ranking FIFA, ha confirmado oficialmente que establecerá su base camp en Kansas City (EE.UU.) durante el torneo. Utilizarán las instalaciones de entrenamiento de Sporting Kansas City (Compass Minerals National Performance Center) y se hospedarán en el área local. Argentina jugará su partido inaugural del Grupo J contra Argelia el 16 de junio en Arrowhead Stadium de Kansas City. Esto genera gran entusiasmo local, con Lionel Messi y el equipo preparándose para defender el título en un lugar que también será base de Inglaterra, lo que promete un ambiente competitivo y festivo. Es visto como una ventaja logística y de adaptación al clima/estadios del Medio Oeste.",
